...
| **65 — Tier 2 focused engineering research** | **Complete:** Answer narrow library/API/migration questions with one fresh-context Claude Code researcher and structured evidence only. | Scoped input projection, source/claim/web budgets, authoritative provenance, machine validation, and T3/T4 escalation checks pass. | Stops at T2; no independent verifier, full swarm, archive, or research-learning artifact. |
| **66 — Tier 3 focused adversarial cross-check** | **Complete:** Independently verify bounded material engineering evidence without invoking the full swarm. | Minimal researcher/verifier contexts, four terminal disposition fixtures, self-approval rejection, bounded T3 termination, and deterministic T4 escalation pass. | Stops after T3; no T4 internals, report synthesis, archive, or research-learning artifact. |
